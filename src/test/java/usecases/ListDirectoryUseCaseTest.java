...
public class ListDirectoryUseCaseTest {
    ...
    public void correctListWithoutArgument() {
        ...
        Assert.assertEquals(13, answer.size());
        ...
        Assert.assertEquals("dir      distributions",answer.get(5));
        Assert.assertEquals("dir      generated", answer.get(6));
        Assert.assertEquals("dir      libs", answer.get(7));
        Assert.assertEquals("dir      reports", answer.get(8));
        Assert.assertEquals("dir      scripts",answer.get(9));
        Assert.assertEquals("dir      test-results", answer.get(10));
        Assert.assertEquals("dir      tmp", answer.get(11));
        Assert.assertEquals("-----------------", answer.get(12));
    }
